...
output_file_name = "all_data.json.gz"  # Name of the output file with .gz extension
...
def main():
    ...
    try:
        ...
        # Upload the compressed data to GCS
        upload_to_gcs(bucket_name, output_file_name, compressed_data)

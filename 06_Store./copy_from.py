...
# Function to add constraints to the table
def addConstraints(conn):
	with conn.cursor() as cursor:
		...
		""")
		print(f"Added constraints and index to {TableName}")

def load_copy(conn, Datafile, rowlist):
    ...
    with conn.cursor() as cursor:
        ...
        with open(Datafile, 'r') as f:
            copy_query = f"COPY {TableName} FROM STDIN WITH (FORMAT CSV, HEADER, DELIMITER ',')"
